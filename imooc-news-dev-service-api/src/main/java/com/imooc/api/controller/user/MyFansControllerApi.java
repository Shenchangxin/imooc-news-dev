...
public interface MyFansControllerApi {
    ...
    public GraceJSONResult isMeFollowThisWriter(@RequestParam(value = "writerId",required = false) String writerId,
                                                @RequestParam String fanId);
    ...
    @ApiOperation(value = "根据地域粉丝数量", notes = "根据地域粉丝数量", httpMethod = "POST")
